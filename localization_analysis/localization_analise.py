...
def generate_reports_a():
    df = pd.read_excel("localization_analysis/Region_analysis.xlsx")
    ...
    fig.write_html("localization_analysis/results/Map_Analysis2.html")
...
def generate_reports():
    ...
    fig = px.choropleth(
        ...
        hover_name="Country",
        color_continuous_scale="Viridis",
        title="Market Potential (Color) & Margin eCPM - CPI (Text)"
    )
    
    # Add margin text to map
    fig.add_trace(
        go.Scattergeo(
    ...
    fig.write_html("localization_analysis/results/Map_Analysis.html")
    ...
    plt.tight_layout()
    plt.savefig("localization_analysis/results/Languages_Margin.png", dpi=300)
    plt.close()
    ...
    plt.xticks(rotation=45, ha='right')
    plt.tight_layout()
    plt.savefig("localization_analysis/results/Regions_Margin.png", dpi=300)
    plt.close()
...
def calculate_language_roi():
    ...
    plt.xticks(rotation=45, ha='right')
    plt.tight_layout()
    plt.savefig("localization_analysis/results/Language_ROI.png", dpi=300)
    plt.close()
    ...
    fig.write_html("localization_analysis/results/ROI_Map.html")
    
    df.to_excel("localization_analysis/Region_analysis_v2.xlsx", index=False)
    print("Done")
...
def calculate_organic_potential():
    ...
    plt.xticks(rotation=45, ha='right')
    plt.tight_layout()
    plt.savefig("localization_analysis/results/Language_Organic_Potential.png", dpi=300)
    plt.close()
    ...
    fig.write_html("localization_analysis/results/Organic_Revenue_Map.html")
...
def calculate_adjusted_roi():
    ...
    plt.tight_layout()
    plt.savefig("localization_analysis/results/Language_Adjusted_ROI.png", dpi=300)
    plt.close()
    ...
    fig.write_html("localization_analysis/results/Adjusted_ROI_Map.html")
    
    df.to_excel("localization_analysis/Region_analysis_v3.xlsx", index=False)
