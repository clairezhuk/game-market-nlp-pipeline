...
def update_android_share():
    try:
        df_excel = pd.read_excel("localization_analysis/Region_analysis.xlsx")
        df_csv = pd.read_csv("localization_analysis/os_combined-ww-monthly-202512-202602-map.csv")
        ...
        df_excel.to_excel("localization_analysis/Region_analysis.xlsx", index=False)
